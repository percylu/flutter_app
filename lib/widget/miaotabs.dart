...
const double _kTabHeight = 86.0;
const double _kTextAndIconTabHeight = 102.0;
...
class MiaoTab extends StatelessWidget {
...
class MiaoTabBar extends StatefulWidget implements PreferredSizeWidget {
...
class _TabBarState extends State<MiaoTabBar> {
  ...
  @override
  void didUpdateWidget(MiaoTabBar oldWidget) {
...
///
/// To see a sample implementation, visit the [TabController] documentation.
class MiaoTabBarView extends StatefulWidget {
  /// Creates a page view with one child per tab.
  ///
  /// The length of [children] must be the same as the [controller]'s length.
  const MiaoTabBarView({
    Key key,
...
class _TabBarViewState extends State<MiaoTabBarView> {
  TabController _controller;
  ...
  @override
  void didUpdateWidget(MiaoTabBarView oldWidget) {
    super.didUpdateWidget(oldWidget);
    if (widget.controller != oldWidget.controller)
      _updateTabController();
