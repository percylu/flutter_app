...
class AuthRegister extends StatefulWidget {
  final type;
  final authuser;
  AuthRegister({this.type,this.authuser});
  @override
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: (_seconds == 0)?() async{
                      ResultData response=await MiaoApi.getAuthCode(userController.text);
              ...
              Container(
                ...
                child: RaisedButton(
                  ...
                  onPressed: () async{
                    ...
                    ResultData response = await MiaoApi.codeAuthVerify(userController.text, verifycodeController.text,type,authuser);
                    ...
                    if(response!=null && response.success) {
                      ...
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (content){
                            return SetPassword(username: userController.text,type:type,authuser:authuser);
                          }
                      ));
